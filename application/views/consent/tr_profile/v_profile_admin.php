                        ...
                        <div class="card-header py-3" id="panel_th_home">
                              ...
                              <div class="col-xl-12">
                                    <h1 class="m-0 font-weight-bold text-primary"><i
                                                class="ti  ti-id-badge text-white" id="Home"></i>
                                                ...
                                                <div class="card border border-primary">
                                                      <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                  ...
                                                                  <div class="col-sm-2">
                                                                        <input type="text" class="form-control"
                                                                              id="grouptext" placeholder="นาย แอดมิน จัดการได้หมด"
                                                                              disabled>
                                                                  </div>
                                                                  ...
                                                                  <div class="col-sm-2">
                                                                        <input type="text" class="form-control"
                                                                              id="grouptext" placeholder="13 ปี 1 เดือน 5 วัน"
                                                                              disabled>
                                                                  </div>
                                                            ...
                                                            &nbsp;&nbsp;&nbsp;&nbsp; ชื่ออังกฤษ :
                                                                  <div class="col-sm-2">
                                                                        <input type="text" class="form-control"
                                                                              id="grouptext" placeholder="Mr. Admin Jatkandaimod"
                                                                              disabled>
                                                                  </div>
                                                                  ...
                                                                  <div class="col-sm-2">
                                                                        <input type="text" class="form-control"
                                                                              id="grouptext" placeholder="Human Resourse"
                                                                              disabled>
                                                                  </div>
