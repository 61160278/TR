                                ...
                                <div class="card border border-primary">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            &nbsp;&nbsp;&nbsp;&nbsp; Type of Training :
                                            <div class="col-sm-1">
                                                <input type="text" class="form-control" id="Show_course_type" disabled>
                                                <input type="text" class="form-control" id="Show_course_id" hidden>
                                            </div>

                                            &nbsp;&nbsp;&nbsp;&nbsp; ครั้งที่ :
                                            <div class="col-sm-1">
                                                <input type="text" class="form-control" id="Show_count" disabled>
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                <input type="text" class="form-control" id="tr_course_code"
                                                    placeholder="Code" onkeyup="get_course()">
                                            </div>
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp; Training Name :
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control" id="Show_course_name"
                                        ...
                                        <div class="row">
                                            &nbsp;&nbsp;&nbsp;&nbsp;Course Category :
                                            <div class="col-sm-2">
                                                <input type="text" class="form-control" id="Show_course_category1"
                                                    disabled>
                                            </div>
                                            <div class="col-sm-2">
                                                <input type="text" class="form-control" id="Show_course_category2"
                                                    disabled>
                                            </div>
                                            <div class="col-sm-2">
                                                <input type="text" class="form-control" id="Show_course_category3"
                                                    disabled>
                                            </div>
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp; Place :
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control" id="place_training"
                                                    placeholder="Place">
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp; Pre-test Score:
                                            <div class="col-1">
                                                <input type="text" class="form-control" id="pre_score">
                                            </div>

                                            &nbsp;&nbsp;&nbsp;&nbsp; Post-test Score :
                                            <div class="col-1">
                                                <input type="text" class="form-control" id="post_score">
                                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="row">
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input class="form-control col-md-2" type="text" placeholder="Employee ID"
                                            aria-label="Search">
